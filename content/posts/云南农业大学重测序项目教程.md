...
title = '云南农业大学重测序项目教程'
categories = ["重测序分析"]
tags = ["群体结构分析","变异检测","重测序","GWAS","QTL-seq"]
...
- [群体结构分析](#%E7%BE%A4%E4%BD%93%E7%BB%93%E6%9E%84%E5%88%86%E6%9E%90)
- [选择分析](#%E9%80%89%E6%8B%A9%E5%88%86%E6%9E%90)
- [GWAS 分析](#gwas%E5%88%86%E6%9E%90)
- [QTL-seq 分析](#qtl-seq%E5%88%86%E6%9E%90)
- [附录：分析流程图](#%E9%99%84%E5%BD%95%E5%88%86%E6%9E%90%E6%B5%81%E7%A8%8B%E5%9B%BE)
...
> ⚠️ 注意：该部分软件很难用 conda 直接安装，安装步骤比较特殊。

### 1. lumpy-sv

💡 lumpy-sv 依赖 Python2.7，需切换到 py27 环境下进行安装。
...
💡 cnvnator 依赖于 root 软件包及 samtools 软件包（包含 HTSlib），因此先安装依赖。
...
df_filt <- filterSNPs(
    SNPset = df,
    refAlleleFreq = 0.20,    # REF等位基因频率: 0.2~0.8
    minTotalDepth = 100,     # 最小总深度
    maxTotalDepth = 400,     # 最大总深度
    minSampleDepth = 40,     # 单样品最小深度
    minGQ = 99,              # 基因型质量阈值
    verbose = TRUE
)
